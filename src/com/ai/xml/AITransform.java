...
public class AITransform implements IAITransform, ICreator, ISingleThreaded
{
   ...
   public static void processHtmlPage( String htmlFilename
      ...
      {
        AITransform parser = new AITransform();
...
//            AppObjects.log("aitransform: Found a simple tag");
            ...
            RLFTag1 tag = new RLFTag1(TAGS_REPLACE_TAG,RLFTagStartIndex, RLFTagEndIndex, tagValue);
