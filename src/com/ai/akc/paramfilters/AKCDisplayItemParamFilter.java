...
public class AKCDisplayItemParamFilter implements Filter
{
	   ...
	   throws IOException, ServletException
	   {
		   ...
		   {
			   //Get the request
			   AKCDisplayItemParamFilterRequest dpfr 
			   		= new AKCDisplayItemParamFilterRequest((HttpServletRequest)request);
