 ...
 */
public class EmbeddedXMLGenericTransform
    ...
    public Document convert(ihds hds) throws TransformException
    {
        try
        {
            return EmbeddedXMLGenericTransformUtils.transformToXML(hds);
        }
 ...
 **************************************************************************
 */
class EmbeddedXMLGenericTransformUtils
{
            ...
            throws DataException
    {
       ...
       {
          CDATASection cds = doc.createCDATASection(val);
          tag.appendChild(cds);
       }
       return tag;
    }
    private static boolean isXML(String ins)
    {
