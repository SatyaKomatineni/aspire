...
public class ConnectionPoolConnectionManager2 implements IConnectionManager, ICreator
 {
    ...
    * Default constructor
    */
   public ConnectionPoolConnectionManager2()
   {
   }
...
class SingleDataSourceConnectionPool
{
  ...
  private ConnectionPoolConnectionItem createNewConnection() 
   ...
   {
      //Lock on the creator
      //only one thread is allowed here
      synchronized(this.createLock)
      {
          ...
          if (con == null)
          {
              ...
              AppObjects.trace(this,
                      "Inside create new connection. No free connection yet. Going to create one.");
          ...
          else
          {
              ...
              AppObjects.trace(this,
                      "Inside create new connection. A free connection is retrurned. Not Going to create one.");
              ConnectionPoolConnectionItem cpItem = 
                  new ConnectionPoolConnectionItem( con, m_dataSourceName );
              return cpItem;
          }
      }
   }                            
  ...
  throws DBException
  {
      AppObjects.info(this,"cp: Creating a new connection to %1s",m_dataSourceName);
