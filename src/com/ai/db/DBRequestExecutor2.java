 ...
 */
public class DBRequestExecutor2 extends DBBaseJavaProcedure
{
   ...
   DBRSCollection2 execQuery( Connection con, boolean bConnectionCreator, String statementString )
      throws java.sql.SQLException
   {
         ...
         try
         {
            ...
            return new DBRSCollection2(con, bConnectionCreator, stmt, rs);
         }
         catch(java.sql.SQLException x)
         {
            AppObjects.trace(this,"db: closing statement and result set due to an exception ");
