 ...
 */      
public class EventEnabledConnectionManager2 implements IConnectionManager, ICreator
 {
    ...
    * Default constructor
    */
   public EventEnabledConnectionManager2()
   {
   }
...
class SingleDataSourceConnectionPool
{
  ...
  class ConnectionPoolCleanupTask implements com.ai.scheduler.IScheduleTask
  {
     public boolean execute()
     {
        ...
        {
            AppObjects.log("Error:DBException while closing.",x);
            throw new RuntimeException("Error:DBException while closing.",x);
        }
     }
  }
   /**
