...
public class Importer extends com.ai.common.ACommandLineApplication
{
  ...
  private Hashtable createLineArgs(Hashtable inArgs, String line)
  {
         ...
         Vector v = com.ai.common.Tokenizer.tokenize(line,",");
         int i=1;
         for (Enumeration e=v.elements();e.hasMoreElements();)
         {
            Integer thisInt = new Integer(i++);
            args.put(thisInt.toString(), e.nextElement());
         }
