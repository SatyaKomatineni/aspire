...
public class RequestBasedMasterPagePart1 extends AMasterPageCreatorPart
{
   ...
   private boolean isCacheNeeded(String cacheControl)
   {
       ...
       if (cacheControl.equalsIgnoreCase("no"))
       {
           return false;
       }
       else
   ...
   {
       String mpRequestName = AppObjects.getValue(requestName + ".masterPageTemplateRN",null);
       String cacheControlKey = AppObjects.getValue(requestName + ".cacheControlKey","masterpageCache");
       String cacheControl = (String)params.get(cacheControlKey.toLowerCase());
       boolean bCacheNeeded = isCacheNeeded(cacheControl);
   ...
   private IMasterPage getMasterPageFromString(String masterPageTemplate)
   {
      ...
      AppObjects.trace(this,"mp:tophalf:%1s", topHalf);
      AppObjects.trace(this,"mp:bottomhalf:%1s",bottomHalf);
