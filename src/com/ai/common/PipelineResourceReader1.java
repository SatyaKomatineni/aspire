 ...
 * 12/19/2012
 * ***********
 * Fixes Bug: params are not lowercased
 * Replaces the deprecated: use instead PipelineResourceReader
 * 
 */
public class PipelineResourceReader1 implements IResourceReader
{
   ...
   throws java.io.IOException
   {
   	try
	{
   		...
   		Map params = PipelineResourceReader1.getParams(queryParams);
