...
public class AITransformWithTranslator implements IAITransform, ICreator, ISingleThreaded
{
   ...
   public static void processHtmlPage( String htmlFilename
      ...
      {
        AITransformWithTranslator parser = new AITransformWithTranslator(evaluator,tagListener);
   ...
   public AITransformWithTranslator(IBooleanExpressionEvaluator evaluator
...
//****************************
                        else if (curRLFTag.getTagName().equals(TAGS_BGN_IF_TAG))
                        {
                           ...
                           String conditionKeyValue = curRLFTag.getDefaultAttributeValue().toLowerCase();
