 ...
 */
public class AITransform6 implements IAITransform, ICreator, ISingleThreaded
{
   ...
   public static void processHtmlPage( String htmlFilename
      ...
      {
        AITransform6 parser = new AITransform6();
   ...
   public AITransform6(IBooleanExpressionEvaluator evaluator)
   {
      if (evaluator != null)
      {
