 ...
 *
 */
public class SimpleBEEvaluator1 implements IBooleanExpressionEvaluator
                              ,ICreator
{
           ...
           ,int curTurn )
   {
       ...
       String conditionValue=getKeyValueFromData(givenKey,pageData,loopData,curTurn);
       ...
       if (targetKey != null)
       {
            targetCompareValue = getKeyValueFromData(targetKey,pageData,loopData,curTurn);
   ...
   private String getKeyValueFromData(String key, IFormHandler pageData, IControlHandler loopData, int curTurn)
   {
       if (loopData != null)
       {
           return loopData.getValue(key,curTurn);
       }
       else
       {
