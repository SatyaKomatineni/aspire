 ...
 *
 */
public class RandomTableHandler61 implements ICreator
            , IControlHandler3
            , ISingleThreaded
            , ILoopRandomIterator
            , ihds
{
      ...
      Vector m_childLoopNames = null;
        ...
        public RandomTableHandler61()
        {
        }
        // Don't call this for regular construction
        public RandomTableHandler61(String handlerName
...
//**********************************************************
                ...
                throws RequestExecutionException
        {
            try
            {
                ...
                String tHandlerName = (String)(args.get(0));
                String handlerName = getHandlerName(tHandlerName);
        ...
        private String getHandlerName(String handlername)
        {
 ...
 */
    ...
    public void close() throws DataException
    {
        ...
        private Vector getChildLoopNames(String handlerName)
        {
                ...
                //Loop names exist
                AppObjects.log("Info:Loop names exist for handler:" + handlerName + " : " + loopNames);
       ...
       {
          String loopname = handlerName;
          AppObjects.log("Trace: setting page counts for loop:" + loopname);
          ...
          else
          {
            ...
            Vector v = Tokenizer.tokenize(loopControlString,",");
            String stCount = (String)v.elementAt(0);
            String rowsToRead = (String)v.elementAt(1);

            AppObjects.log("Trace: Paging enabled with " + stCount + "," + rowsToRead);
