 ...
 */
public class GenericTableHandler4 implements ICreator, IControlHandler3, ISingleThreaded
{
      ...
      boolean bFirstTimeGotoNextRow = true; // To give a counter to the gotoNextRow
        ...
        public GenericTableHandler4()
        {
        }
        public GenericTableHandler4(String handlerName
