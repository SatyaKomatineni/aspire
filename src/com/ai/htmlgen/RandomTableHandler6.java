 ...
 *
 */
public class RandomTableHandler6 implements ICreator
            , IControlHandler3
            , ISingleThreaded
            , ILoopRandomIterator
            , ihds
{
      ...
      Vector m_childLoopNames = null;
        ...
        public RandomTableHandler6()
        {
        }
        // Don't call this for regular construction
        public RandomTableHandler6(String handlerName
 ...
 */
    ...
    public void close() throws DataException
    {
       ...
       private void setPageCounts(String handlerName, Hashtable args)
       {
          ...
          String controlStringKey = loopname + "_controlstring";
