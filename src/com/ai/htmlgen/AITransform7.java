 ...
 * **********
 * Deprecation notes:
 * we are using a more recent version.
 * 
 * other older notes
 * *********************
      ...
      implements IAITransform, ICreator, ISingleThreaded, IInitializable, IGenericTransform, IFormHandlerTransform
{
   ...
   public static void processHtmlPage( String htmlFilename
      ...
      {
        AITransform7 parser = new AITransform7();
   ...
   public AITransform7(IBooleanExpressionEvaluator evaluator)
   {
      if (evaluator != null)
      {
