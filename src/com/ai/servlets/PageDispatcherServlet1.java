...
/**
 * PageDispatcherServlet1 notes
 * ********************************
 * Dec 16th 2007
 * Based on PageDispatcherServlet
 * introduced for master page support for those using AITransform
 * 
 * PageDispatcherServlet notes
 * ********************************
...
public class PageDispatcherServlet1 extends ProfileEnabledServlet
{
  public void init(ServletConfig config) throws ServletException
  {
      ...
      throws ServletException, IOException
   {
      ...
      try
      {
    	  AppObjects.info(this, parameters.toString());
          ...
          {
        	  PageDispatcherServlet1.performAITransform(
        			  (IAITransform)trObj
        			  , templateHtml
        			  , out
...
//         AppObjects.log(x);
    ...
    */
     ...
     *****************************************************************
     */
    private static void performAITransform(IAITransform trObj
    		, String urlTemplate
    		, PrintWriter out
    		, IFormHandler formHandlerObject
            ,HttpServletRequest request
    ...
    throws IOException, RequestExecutionException, ServletException
    {
    	IAIPostTransform pt = getPostTransformWrapper();
    	pt.transform(urlTemplate, out, formHandlerObject, trObj, request, response);
    }
    
    private static IAIPostTransform getPostTransformWrapper()
    throws RequestExecutionException
    {
    	String ptobjname = AppObjects.getValue("request.aspire.posttransform.classname",null);
    	if (ptobjname == null)
    	{
    		return DefaultPostTransform.self;
    	}
    	//post transform object exists
   		return (IAIPostTransform)AppObjects.getObject("aspire.posttransform", null);
    }
    /*****************************************************************
     * getDataTransform
     *****************************************************************
